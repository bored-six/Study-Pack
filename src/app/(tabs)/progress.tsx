      ...
      <ScrollView
        ...
        {nothingYet ? (
          <View style={styles.emptyCard}>
            ...
            {/* On the web this empty state is misleading on its own: it reads as
                "you have not studied" when the truth is "a browser cannot hold
                this". Renders nothing on a phone. */}
