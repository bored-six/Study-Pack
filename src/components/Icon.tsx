...
const glyphs = {
  ...
  play: (f: string, ink: string) => (
    <Path
      d="M8.2 4.6c3.8 1.7 7.2 4.2 10.6 7.4-3.6 2.6-7.1 4.6-10.9 6.1.4-4.5.2-9 .3-13.5z"
      fill={f === 'none' ? ink : f}
    />
  ),
  check: () => (
  ...
  flame: (f: string) => (
    <Path
      d="M15 2.4c-2.6 2.4-3.2 4.8-2.1 7.8-1-.1-1.7-.6-2.2-1.6-1.5 1.5-2.5 3.1-2.7 5a5.2 5.2 0 0 0 10.3 1.3c.4-2.5-1.2-4.4-2.8-6.3-1.5-1.8-1.3-3.5-.5-6.2z"
      fill={f}
    />
  ),
  trophy: (f: string) => (
  ...
  star: (f: string) => (
    <Path
      d="M12.7 2.8l2 5.7 6.4.7-4.9 4.3 2 6.6-6.1-3.6-6.4 3.2 1.9-6.6L3 8.9l6.6-.6z"
      fill={f}
    />
  ),
  // ── deck categories ────────────────────────────────────────
  ...
  heart: (f: string) => (
    <Path
      d="M11.6 20.6S3.9 15.5 4.6 10.1a4.3 4.3 0 0 1 7.2-2.5c.8-2.2 3.5-3.3 5.7-2.2 2.1 1 3 3.5 2.1 5.9-1.3 3.8-5.7 7.1-8 9.3z"
      fill={f}
    />
  ),
  question: (f: string) => (
