...
const glyphs = {
  ...
  cards: (f: string) => (
    <>
      ...
      <Circle cx={8} cy={13} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={12} cy={13} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M9 15h2" />
    </>
  ),
  ...
  chart: (f: string) => (
    <>
      ...
      <Circle cx={12} cy={8} r={0.8} fill={colors.ink} stroke="none" />
    </>
  ),
  ...
  book: (f: string) => (
    <>
      ...
      <Circle cx={7} cy={11} r={1.2} fill={colors.ink} stroke="none" />
      <Circle cx={9.5} cy={10.5} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M7 14c0.5 1 1.5 1 2 0" />
      <Path d="M7.5 14.5v1.5c0 1 1 1 1 0v-1.5" fill={colors.coral} />
    </>
  ),
  note: (f: string) => (
    <>
      ...
      <Circle cx={12} cy={10} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={10} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M12 12h2" />
    </>
  ),
  pencil: (f: string) => (
    <>
      <Path d="M18 4l2 2 -3 3 -2 -2z" fill={colors.coral} />
      <Path d="M15 7l2 2 -8 8 -3 -1 1 -3z" fill={f} />
      <Path d="M5 15l1 -3 -3 4 2 0z" />
      <Path d="M3 16l1 -1 -1 1z" fill={colors.ink} />
      <Circle cx={9} cy={11} r={0.8} fill={colors.ink} stroke="none"/>
      <Circle cx={11.5} cy={13.5} r={0.8} fill={colors.ink} stroke="none"/>
  ...
  flask: (f: string) => (
    <>
      ...
      <Circle cx={9.5} cy={17} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14.5} cy={17} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 19h2" />
  ...
  globe: (f: string) => (
    <>
      ...
      <Path d="M3.5 12h17" />
      <Circle cx={9} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={10} r={1.5} fill={colors.ink} stroke="none" />
      <Path d="M11 14h2" />
    </>
  ),
  museum: (f: string) => (
    <>
      ...
      <Path d="M4 20.5h16.5" />
      <Circle cx={12} cy={8} r={1} fill={colors.ink} stroke="none" />
    </>
  ),
  monitor: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={10} r={1.5} fill={colors.ink} stroke="none" />
      <Path d="M11 13h2" />
    </>
  ),
  ...
  leaf: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={11} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Path d="M10 14h2" />
    </>
  ),
  sprout: (f: string) => (
    <>
      ...
      <Circle cx={8} cy={12} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={10} r={0.8} fill={colors.ink} stroke="none" />
    </>
  ),
  flower: (f: string) => (
    <>
      ...
      <Circle cx={11} cy={11.5} r={0.5} fill={colors.ink} stroke="none" />
      <Circle cx={13} cy={11.5} r={0.5} fill={colors.ink} stroke="none" />
      <Path d="M11 13h2" />
    </>
  ),
  paw: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={15} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={15} r={1} fill={colors.ink} stroke="none" />
    </>
  ),
  cat: (f: string) => (
    <>
  ...
  star: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={13} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={12} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 15h2" />
    </>
  ),
  spark: (f: string) => (
  ...
  flameBig: (f: string) => (
    <>
      ...
      <Path d="M12 12.6c.9 1.3 1.7 2.2 1.7 3.4a1.7 1.7 0 0 1-3.4 0c0-1.2.8-2.1 1.7-3.4z" fill={colors.surface} />
    </>
  ),
  flameCrown: (f: string) => (
    <>
  ...
  heart: (f: string) => (
    <>
      ...
      <Circle cx={8} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={8} r={1} fill={colors.ink} stroke="none" />
      <Path d="M10 12h3" />
    </>
  ),
  // ── Fun ────────────────────────────────────────────────
  palette: (f: string) => (
    <>
      ...
      <Circle cx={7} cy={9} r={1.5} fill={colors.ink} stroke="none" />
      <Circle cx={12} cy={11} r={1.2} fill={colors.ink} stroke="none" />
  ...
  gamepad: (f: string) => (
    <>
      ...
      <Circle cx={15.2} cy={11.3} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={17.4} cy={13.7} r={1} fill={colors.ink} stroke="none" />
      <Path d="M10 15h4" />
    </>
  ),
  dice: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={15} r={1.5} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={9} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M10 13c1 2 3 1 4 0" fill={colors.coral} />
    </>
  ),
  clapper: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={14} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={14} r={1} fill={colors.ink} stroke="none" />
      <Path d="M10 16h3" />
    </>
  ),
  tv: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={12} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={12} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 15h2" />
    </>
  ),
  trophy: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={7} r={1.2} fill={colors.ink} stroke="none" />
  ...
  smartphone: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={10} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={10} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M11 13h2" />
    </>
  ),
  car: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 12h2" />
    </>
  ),
  plane: (f: string) => (
    <>
      ...
      <Circle cx={13} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={16} cy={7} r={0.8} fill={colors.ink} stroke="none" />
    </>
  ),
  flag: (f: string) => (
    <>
      ...
      <Path d="M5.5 21V3.5" />
      <Circle cx={10} cy={8} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={9} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M11 11h2" />
    </>
  ),
  bolt: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={9} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 11h2" />
    </>
  ),
  ...
  clock: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 15h2" />
    </>
  ),
  calendar: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={14} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={14} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 17h2" />
    </>
  ),
  bell: (f: string) => (
    <>
      ...
      <Circle cx={9} cy={10} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={11} r={1.5} fill={colors.ink} stroke="none" />
      <Path d="M11 13h2" />
    </>
  ),
  bulb: (f: string) => (
    <>
      ...
      <Circle cx={9.5} cy={9} r={1.2} fill={colors.ink} stroke="none" />
      <Circle cx={14.5} cy={10} r={1.8} fill={colors.ink} stroke="none" />
  ...
  plus: () => (
    <>
      ...
      <Circle cx={9} cy={8} r={1.5} fill={colors.ink} stroke="none" />
      <Circle cx={15} cy={8} r={1.5} fill={colors.ink} stroke="none" />
    </>
  ),
  trash: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={13} r={1} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={13} r={1} fill={colors.ink} stroke="none" />
      <Path d="M11 16h2" />
    </>
  ),
  derpBrain: (f: string) => (
  ...
  gear: (f: string) => (
    <>
      ...
      <Circle cx={10} cy={11} r={0.8} fill={colors.ink} stroke="none" />
      <Circle cx={14} cy={11} r={0.8} fill={colors.ink} stroke="none" />
      <Path d="M11 14h2" />
    </>
  ),
  sound: (f: string) => (
